<template>
  <div class="block-todays-wallpaper">
    <h2 class="block-todays-wallpaper__title">Today's wallpapers</h2>
    <TodaysWallpaper
...
export default {
  ...
  methods: {
    ...mapActions(["GET_TODAYS_WALLPAPERS_FROM_API"]),
  },
  ...
  computed: {
    ...
    mainTodaysWalpaper() {
      return this.todaysWallpapers.slice(0, 3);
    },
  },
...
<style lang="scss">
@import "BlockTodaysWallpaper.scss";
</style>